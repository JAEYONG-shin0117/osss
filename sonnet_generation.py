...
class SonnetGPT(nn.Module):
  ...
  def generate(self, encoding, temperature=1.0, max_length=128, num_beams=5, repetition_penalty=1.2):
    ...
    # <|endoftext|> 토큰 제거
    generated_output = generated_output.replace(self.tokenizer.eos_token, "").strip()
...
def get_args():
  ...
  parser.add_argument("--true_sonnet_path", type=str, default="data/TRUE_sonnets_held_out.txt")
